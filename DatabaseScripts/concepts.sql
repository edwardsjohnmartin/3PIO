...
CREATE OR REPLACE FUNCTION sproc_write_concept_create(name text, section int, project int, project_open_date timestamp, project_due_date timestamp, lessons int[])
RETURNS TABLE(id int) AS $$
	DECLARE
		ret_id int;
	BEGIN
	INSERT INTO concepts AS c (name, section_id, project_id, project_open_date, project_due_date)
	VALUES (sproc_write_concept_create.name, sproc_write_concept_create.section, sproc_write_concept_create.project, sproc_write_concept_create.project_open_date, sproc_write_concept_create.project_due_date) RETURNING c.id INTO ret_id;
...
CREATE OR REPLACE FUNCTION sproc_write_concept_update(id int, name text, section int, project int, project_open_date timestamp, project_due_date timestamp, lessons int[])
RETURNS VOID AS $$
