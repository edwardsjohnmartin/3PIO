	...
	class SandboxController
	{
		public function index()
		{
			...
			$dropdown_items = array(
				new dropdown_item('drp_instructions', 'Instructions', 'Write code and test it out here. Any code entered here will not be saved. Play around and try new things. \n\nYou can use the down arrow button to transfer the code from here to the code editor area below.\n\nThe slider bar to the left can be used to change the size of the text and graphic output areas.\nCaution: Resizing with the slider bar will erase what is currently drawn.'),
