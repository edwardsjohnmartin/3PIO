...
//participating in into the session. This will make so they don't have to log out then
//in when a teacher adds them to a section.
	...
	public function log_in(){
		if ($_SERVER['REQUEST_METHOD'] === 'POST'){
			...
			if ($model->get_id() != null){
				...
				//Store what sections they have access to as each role and which sections they are a study participant into the session
				//Note: Section::get_study_pairs_for_student does not check the timestamps so this will fill even if it is not within the section start and end time
